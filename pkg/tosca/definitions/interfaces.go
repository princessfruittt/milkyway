...
//		i.Implementation = tosca.Implementation{Primary: s}
//		return nil
//	}
//	var str struct {
//		Inputs         map[string]tosca.Input `yaml:"inputs,omitempty"`
//		Description    string                 `yaml:"description,omitempty"`
//		Implementation tosca.Implementation   `yaml:"implementation,omitempty"`
...
//
//	if str.Outputs != nil {
//		i.Outputs = make(map[string]tosca.Output)
//		for outputName, outputAttributeMapping := range str.Outputs {
//			attributeMapping, err := tosca.parseAttributeMapping(outputAttributeMapping)
//			if err != nil {
//				return err
//			}
//			i.Outputs[outputName] = tosca.Output{AttributeMapping: attributeMapping}
//		}
//	}
//	return nil
//}
