...
func (nt *NodeType) AddProperty(k string, v definitions.PropertyDefinition) {
	nt.Properties[k] = v
}
...
type NodeType struct {
	Type       `yaml:",inline"`
	Properties map[string]definitions.PropertyDefinition  `yaml:"properties,omitempty" json:"properties,omitempty"`
	Attributes map[string]definitions.AttributeDefinition `yaml:"attributes,omitempty" json:"attributes,omitempty"`
	//Requirements []RequirementDefinitionMap      `yaml:"requirements,omitempty,flow" json:"requirements,omitempty"`
	Capabilities map[string]definitions.CapabilityDefinition `yaml:"capabilities,omitempty" json:"capabilities,omitempty"`
	Interfaces   map[string]definitions.InterfaceDefinition  `yaml:"interfaces,omitempty" json:"interfaces,omitempty"`
	Artifacts    map[string]definitions.ArtifactDefinition   `yaml:"artifacts,omitempty" json:"artifacts,omitempty"`
}
